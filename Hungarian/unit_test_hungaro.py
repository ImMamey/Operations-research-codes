...
class TestHunga(unittest.TestCase):
    @parameterized.expand([
        ["Caso 1", [[50, 130, 190],[130, 100, 150],[110, 150, 270],[150, 90, 60]],[[3, 4], [1, 1], [2, 2], [4, 3]], 210],
        ["Caso 2", [[8,7,9,8,6],[4,5,3,5,3],[2,3,4,3,2],[7,6,8,6,7],[5,4,4,6,3]],[[1, 1], [2, 2], [3, 3], [4, 5]], 30],
        ["Caso 3",[[10,9,5],[9,8,3],[6,4,7]],[[2,3],[1,1],[3,2]],17],
        ["Caso 4", [[180,150,200,200],[250,305,450,500],[200,208,320,100]],[[2,1],[1,2],[4,3],[3,4]],500]
    ])

    def test_sequence(self,nombre,rest,expected_coors,expected_costo):
        result = inicio(rest)
        if result is not None and len(result) == 2:
            ...
            self.assertTrue(result and len(result) == 2, "La funcion no devolvio el resultado esperado")
